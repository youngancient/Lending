...
library LibDiamond {
    ...
    struct Loan {
        ...
        uint256 loanStartTime; // Start time of the loan
        uint256 loanDuration; // Duration in seconds
        LoanStatus loanStatus; // True if loan is active, false if repaid or defaulted
    }
    // let's say interest is 10%
